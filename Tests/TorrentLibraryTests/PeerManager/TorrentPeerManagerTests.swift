...
final class TorrentPeerManagerTests: XCTestCase {
    ...
    func createFakePeer() -> TorrentPeer {
        let peerInfo = TorrentPeerInfo(ip: "127.0.0.1", port: 123, id: nil)
        let communicator = TorrentPeerCommunicatorStub(peerInfo: peerInfo, infoHash: infoHash)
        return TorrentPeerFake(peerInfo: peerInfo, bitFieldSize: bitFieldSize, communicator: communicator)
    }
    ...
    func test_newPeersConnect() {
        // Given
        let peerInfo1 = TorrentPeerInfo(ip: "127.0.0.1", port: 123, id: nil)
        let peerInfo2 = TorrentPeerInfo(ip: "127.0.0.1", port: 123, id: nil)
    ...
    func test_doesNotConnectToMoreThanMax() {
        ...
        let peerInfo1 = TorrentPeerInfo(ip: "127.0.0.1", port: 123, id: nil)
        let peerInfo2 = TorrentPeerInfo(ip: "127.0.0.1", port: 123, id: nil)
        let peerInfo3 = TorrentPeerInfo(ip: "127.0.0.1", port: 123, id: nil)
